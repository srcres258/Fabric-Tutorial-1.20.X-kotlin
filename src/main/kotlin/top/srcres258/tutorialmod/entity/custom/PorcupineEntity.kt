...
import top.srcres258.tutorialmod.entity.ai.PorcupineAttackGoal
import kotlin.math.min

class PorcupineEntity(entityType: EntityType<out AnimalEntity>?, world: World?) : AnimalEntity(entityType, world) {
    companion object {
        private val ATTACKING: TrackedData<Boolean> =
            DataTracker.registerData(PorcupineEntity::class.java, TrackedDataHandlerRegistry.BOOLEAN)
    ...
    override fun initGoals() {
        goalSelector.let { gs ->
            ...
            gs.add(1, PorcupineAttackGoal(this, 1.0, true))
    ...
    override fun isAttacking(): Boolean = dataTracker.get(ATTACKING)
