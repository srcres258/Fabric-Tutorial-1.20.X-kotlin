...
import top.srcres258.tutorialmod.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
    ...
    public void setAngles(PorcupineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.updateAnimation(entity.getIdleAnimationState(), ModAnimations.PORCUPINE_IDLE, ageInTicks, 1f);
        this.updateAnimation(entity.getAttackAnimationState(), ModAnimations.PORCUPINE_ATTACK, ageInTicks, 1f);
    }
